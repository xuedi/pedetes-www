...
('about', 'fr', 'About'),
('about', 'zh', '关于'),
('about_headline', 'de', 'Über'),
('about_headline', 'en', 'Regional and traditional French products from Aveyron'),
('about_headline', 'fr', 'Produit régionale et traditionnelle française de l&#39;Aveyron'),
('admin', 'de', 'Admin'),
('admin', 'en', 'Admin'),
('admin', 'fr', 'Admin'),
('admin', 'zh', '管理'),
...
('settings', 'zh', '设置'),
('title', 'en', 'beijingcode.local'),
('translations', 'de', 'Übersetzungen'),
('translations', 'en', 'Translations'),
('translations', 'fr', 'Translations'),
('translations', 'zh', '翻译'),
('url', 'de', 'handmade-in-aveyron.com'),
('url', 'en', 'beijingcode.local'),
('url', 'fr', 'handmade-in-aveyron.com'),
('url', 'zh', 'handmade-in-aveyron.com'),
('user', 'de', 'Benutzer'),
('user', 'en', 'User'),
('user', 'fr', 'User'),
('user', 'zh', '用户');
